## Test pid studies 
#!bin!bash
OPTION="-b --configuration json://Config_pid.json"
LOGFILE="log.txt"
...
o2-analysis-track-propagation $OPTION --aod-file @input_data_pid.txt --aod-writer-json OutputDirector_pid.json > "$LOGFILE" 2>&1
