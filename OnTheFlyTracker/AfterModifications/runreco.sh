...
echo "Starting reconstruction in folder /home/mdicosta/LocalTestsO2/OnTheFlyTracker/AfterModifications"

o2-analysis-onthefly-tracker -b --configuration json://./../config_reco.json |
o2-analysis-on-the-fly-detector-geometry-provider -b --configuration json://./../config_reco.json --aod-file @input.txt --aod-writer-json OutputDir.json > log_reco.txt 2>&1
