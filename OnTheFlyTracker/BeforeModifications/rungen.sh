...
o2-sim-dpl-eventgen --generator external --nEvents 10000 --aggregate-timeframe 50 --configFile $O2DPG_MC_CONFIG_ROOT/MC/config/ALICE3/ini/pythia8_pp.ini -b --configuration json://config_gen.json |
