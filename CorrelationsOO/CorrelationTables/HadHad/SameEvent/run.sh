...
# o2-analysis-hf-correlator-flow-charm-hadrons-reduced $OPTION --shm-segment-size 300000000 --aod-memory-rate-limit 50000000 --aod-writer-json ../../OutputDir.json --aod-file @../../input_derived_data.txt 1 > $LOGFILE 2>&1
