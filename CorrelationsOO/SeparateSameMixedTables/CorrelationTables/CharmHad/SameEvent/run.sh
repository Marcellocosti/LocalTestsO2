...
o2-analysis-hf-correlator-flow-charm-hadrons-reduced $OPTION --aod-writer-json ../../OutputDir.json --aod-file @input_derived_data_same_charm_had.txt 1 > $LOGFILE 2>&1
