...
o2-analysis-event-selection-service $OPTION --aod-writer-json ../../OutputDir.json --aod-file @../../input_OO.txt --shm-segment-size 300000000000 --aod-memory-rate-limit 50000000000 --aod-parent-access-level 1 > $LOGFILE 2>&1
