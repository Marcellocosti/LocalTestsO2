...
o2-analysis-qvector-table $OPTION --aod-writer-json OutputDir.json --resources-monitoring 2 --aod-file @input_data.txt  --aod-memory-rate-limit 20000000000 --shm-segment-size 75000000000 --aod-parent-access-level 1 > "$LOGFILE" 2>&1
