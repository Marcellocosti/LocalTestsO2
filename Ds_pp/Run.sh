LOGFILE="log.txt"
OPTION="-b --configuration json://Config_derived.json"
...
o2-analysis-ft0-corrected-table $OPTION --aod-file @input_data.txt --aod-writer-json OutputDirector.json --aod-parent-access-level 1 > $LOGFILE 2>&1
# report status
rc=$?
if [ $rc -eq 0 ]; then
  echo "No problems!"
