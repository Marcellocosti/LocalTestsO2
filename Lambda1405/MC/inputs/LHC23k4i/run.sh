...
o2-analysis-lf-sigmaminus-task $OPTION |\
o2-analysis-tracks-extra-v002-converter $OPTION |\
o2-analysis-lf-lambda1405analysis $OPTION --aod-writer-json ../OutputDir.json --aod-file @input_data_${DATASET}.txt --shm-segment-size 7500000000 --aod-parent-access-level 1 severity debug > "$LOGFILE" 2>&1
