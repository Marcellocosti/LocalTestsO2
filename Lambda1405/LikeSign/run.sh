...
o2-analysis-lf-lambda1405analysis $OPTION --aod-writer-json OutputDir.json --aod-file @input_data.txt --shm-segment-size 7500000000 --aod-parent-access-level 1 severity debug > "$LOGFILE" 2>&1
