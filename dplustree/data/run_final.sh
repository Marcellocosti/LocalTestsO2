...
o2-analysis-centrality-table $OPTION --aod-file @input_mc_pp.txt --aod-writer-json OutputDirector.json > log.txt 2>&1
# o2-analysis-centrality-table $OPTION --aod-file @input_mc_pbpb_shared.txt  > log.txt 2>&1
